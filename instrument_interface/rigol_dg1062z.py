from instrument_interface.instrument_base import Instrument
...
class RigolDG1062Z(Instrument):
    ...
    def set_function(self, channel, func):
        """
        func = SIN, SQU, RAMP, PULSE, NOIS, ARB, DC …
        """
    ...
    def high_impedance_mode(self, channel):
        """Set output to High-Z (important when driving a scope directly)."""
